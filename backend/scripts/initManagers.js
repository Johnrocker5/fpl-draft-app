...
async function initManagers() {
  try {
    ...
    const managers = [
      ...
      { _id: 'UqOaR8lvCjerDPSOQGbM7NXgCG53', email: 'dhbatt@yahoo.com', name: 'Dean', isAdmin: false, budget: 1000, playersRequired: 15, positionCounts: { GKP: 0, DEF: 0, MID: 0, FWD: 0 }, playersOwned: [] }
